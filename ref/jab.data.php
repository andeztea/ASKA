...
<tbody>
    <?php 
        ...
        $jml_data = mysql_num_rows(mysql_query("SELECT * FROM jabatan order by id_jab desc"));
        ...
        // query jika nomor halaman sudah ditentukan
            ...
            $query = mysql_query("SELECT * FROM jabatan order by id_jab desc LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");
        // query ketika tidak ada parameter halaman maupun pencarian
        } else {
            $query = mysql_query("SELECT * FROM jabatan order by id_jab desc  LIMIT 0, $jml_per_halaman");
            $halaman = 1; //tambahan
        }
